...
App.start();
App.module('Helpers', function(Helpers, App, Backbone, Marionette, $, _) {
  ...
  Helpers.convertLargeNum = function(Num) {
    return Num.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
  },

  Helpers.configxhr = function() {
